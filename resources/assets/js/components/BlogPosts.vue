  ...
  <div class="blog-section">
    <div class="container">
      ...
      <p class="section-description">
        ...
        nisi, consequuntur illum dolores cumque pariatur quis provident deleniti
        nesciunt officia est reprehenderit sunt aliquid possimus temporibus enim
        eum hic.
      </p>
      ...
      <div class="blog-posts">
        <div v-for="post in posts" :key="post.id" class="blog-post">
          ...
          <a :href="post.link"
            ><h2 class="blog-title">{{ post.title.rendered }}</h2></a
          >
...
export default {
  ...
  created() {
    axios
      .get(
        "https://blog.laravelecommerceexample.ca/wp-json/wp/v2/posts?per_page=3"
      )
      .then((response) => {
